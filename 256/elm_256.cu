...
#define BLOCK_DIM 16
#define train_sample 7710
#define test_sample 22897
#define feature 512
#define hidden 1000
#define output_dim 257
#define batchSize 1
...
int main()
{
	...
	char xtrain_file[100] = "xtrain256.csv";
	char xtest_file[100] = "xtest256.csv";
	char ytrain_file[100] = "ytrain256.csv";
	char ytest_file[100] = "ytest256.csv";
	char win_file[100] = "Win256.csv";
	cublasHandle_t handle;

	double c = (1.0f / 256.0f);
